...
<div id="article-badge" class="article-badge beginner">⭐ Beginner View</div>
  ...
  <div class="difficulty beginner-version">
    ...
    <section class="section-light">
      <p>Microsoft Word is <span class="glossary-hover" data-term="word-processing">word processing</span> <span class="glossary-hover" data-term="application">application</span> primarily considered the office standard for word processing globally. It comes as part of the <span class="glossary-hover" data-term="microsoft-office">Microsoft Office</span> suite, a package of several Microsoft applications, such as Outlook for emails and Excel for spreadsheets.</p>
      <p>If you're new to Microsoft Word ('Word' for short), then chances are you're new to a lot of things in Windows. This article is for starting off with the absolute basics; in this article we'll explore:</p>
      <ul>
  ...
  <div class="difficulty intermediate-version" style="display:none;">
    ...
    <section class="section-light">
      ...
      <ul>
        <li><a href="#word-version">Word versions<a></li>
        <li><a href="#create-new-word-doc">Creating a new document</a></li>
        <li><a href="#open-word-doc">Opening existing Word files</a></li>
        <li><a href="#word-interface">The main interface</a></li>
        <li><a href="#close-word-doc">Closing a document in the app</a></li>
        <li><a href="#close-word-app">Closing the app</a></li>
      </ul>
      <h2 id="word-version">Word versions</h2>
        <p>There are a few versions of Microsoft Word:</p>
        <table>
            <colgroup>
              <col style="width: 20%;">
