...
tags:
  ...
  - edit custom table of contents
  - edit a custom table of contents
  - update custom table of contents
  - update a custom table of contents
  - updating custom table of contents
...
<p>In this article:</p>
<ul>
    <li><a href="#insert-toc">Inserting a custom table of contents</a></li>
    <li><a href="#custom-toc-options">Options</a></li>
    <li><a href="#table-entry-fields">Table entry fields</a></li>
    <li><a href="#modify-toc-options">Modify (styles)</a></li>
</ul>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/TOC/Mark TOC entry.png' | url }}"  alt="Mark Table of Contents Entry dialog in Word" style="width:55%; vertical-align:middle"></p>
<ol>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/TOC/TC field.gif' | url }}"  alt="Custom TC field in Word" style="width:65%; vertical-align:middle"></p>
