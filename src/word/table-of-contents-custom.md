...
<p><img class="thumbnail border" src="{{ '/assets/images/word/TOC/TC field.gif' | url }}"  alt="Custom TC field in Word" style="max-width:400px; width:100%; height:auto; vertical-align:middle"></p>
