...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Edit%20data.gif' | url }}" alt="Excel chart in Word edit data" style="max-width: 100%; height: auto; display: inline; margin: auto;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Refresh%20data.png' | url }}" alt="Refresh data" style="max-width: 100%; height: auto; display: inline; margin: auto;"></p>