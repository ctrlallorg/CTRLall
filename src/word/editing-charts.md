...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Refresh data.png' | url }}" alt="Refresh chart data button on ribbon in Word" style="max-width:500px; width:100%; height:auto; vertical-align:middle"></p>
