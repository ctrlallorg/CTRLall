...
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Selecting%20text%20click%20and%20drag.gif' | url }}" alt="Selecting text by click and drag in Word">
...
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Selecting%20text%20word%20double%20click.gif' | url }}" alt="Selecting text word by double clicking in Word">
Select a paragraph by triple clicking on a word in it:
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Selecting%20text%20paragraph%20triple%20click.gif' | url }}" alt="Selecting text paragraph by triple clicking in Word">
...
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Selecting%20punctuation%20mid%20sentence.gif' | url }}" alt="Selecting punctuation in the middle of a sentence in Word">
...
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Select%20full%20stop%20period%20next%20to%20quotation%20mark.gif' | url }}" alt="Selecting a full stop period next to a quotation mark in Word">
...
<img class="thumbnail border" src="{{ '/assets/images/word/Selecting%20text/Selecting%20text%20margin.gif' | url }}" alt="Selecting a row of text by clicking the margin in Word">