...
<p>Images are a different matter though and can cause a few issues. If you're experiencing problems with images and tables take a look at this article: <a href="/word/tables-fixing-table-image-problems/">Tables: Fixing table image problems</a></p>

<h4 id="image-table-resize">I pasted an image into my table and it's altered my columns and rows</h4>
...
<h2>Table gone wrong? Try these fixes:</h2>
...
<section class="section-light">
  ...
  <h4>I want my content/text to sit at the bottom or centre of a cell not the top</h4>
  <p>That's altered via <strong>cell alignment</strong> options. By default table content is aligned top left.</p>
  <p>See cell alignment here: <a href="/word/tables-formatting/#table-cell-alignment">Table cell alignment</a></p>
