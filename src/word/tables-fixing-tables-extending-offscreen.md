...
<img class="thumbnail border" src="{{ '/assets/images/word/Tables fixing tables extending offscreen/Example table distributed columns.png' | url }}" alt="Table with columns evenly distributed" style="max-width:550px; width:100%; height:auto; vertical-align:middle">
