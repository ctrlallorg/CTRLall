...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Ribbon images.png' | url }}" alt="Insert picture images menu on ribbon in Word" style="display: inline; height: 30%; width: 30%;"></p>
<ul>
...
<div class="table-wrapper">
  <table class="no-border">
    ...
    <tbody>
      <tr>
        <td>From Device</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/From device.png' | url }}" alt="Insert picture image browse window"  style="display: inline; height: 100%; width: 100%;"></td>
      </tr>
      <tr>
        <td>Stock Images</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Stock images.png' | url }}" alt="Stock Images gallery in Word" style="display: inline; height: 100%; width: 100%;"></td>
      </tr>
      <tr>
        <td>Online Pictures</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Online pictures.png' | url }}" alt="Online Pictures gallery in Word" style="display: inline; height: 100%; width: 100%;"></td>
      </tr>
    </tbody>
  </table>
</div>
...
<table>
  <colgroup>
    ...
    <thead>
      ...
      <tbody>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Insert shapes.png' | url }}" alt="Insert shapes from Insert on ribbon in Word" style="display: block; height: 150%; width: 100%;"></td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Insert icons.png' | url }}" alt="Insert icons from Insert on ribbon in Word" style="display: block; height: 100%; width: 100%;"></td>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Insert shapes options.png' | url }}" alt="Insert shapes menu on ribbon in Word" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/Typing inside shape.png' | url }}" alt="Typing inside a shape" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Stock images gallery.png' | url }}" alt="Stock images icon gallery in Word" style="max-width: 75%; height: auto; display: inline;"></p>
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/Icon examples.png' | url }}" alt="Icon examples in Word" style="max-width: 75%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/3D models.png' | url }}" alt="3D models gallery in Word" style="max-width: 75%; height: auto; display: inline;"></p>
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/3D model examples.png' | url }}" alt="3D model examples in Word" style="max-width: 75%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/SmartArt menu.png' | url }}" alt="SmartArt option on ribbon in Word" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/SmartArt example.png' | url }}" alt="SmartArt example in Word" style="max-width: 75%; height: auto; display: inline;"></p>
...
<img class="thumbnail" src="{{ '/assets/images/word/Images/Chart menu.png' | url }}" alt="Chart option on ribbon in Word" style="max-width: 75%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Chart word inserted.png' | url }}" alt="Chart inserted onto page in Word" style="max-width: 75%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Excel chart copy paste into word.gif' | url }}" alt="Excel chart copied and pasted from Excel into Word" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Screenshot inserted.png' | url }}" alt="Screenshot inserted with selection frame showing" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Screen clipping inserted.gif' | url }}" alt="Screen clipping taken and inserted onto page in Word" style="max-width: 100%; height: auto; display: inline;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/WordArt menu.png' | url }}" alt="WordArt menu on ribbon in Word" style="max-width: 100%; height: auto; display: inline;"></p>
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Wordart inserted.png' | url }}" alt="WordArt inserted onto page" style="max-width: 100%; height: auto; display: inline;"></p>
