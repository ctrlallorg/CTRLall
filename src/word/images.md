...
<div class="table-wrapper">
  <table class="no-border">
    ...
    <tbody>
      <tr>
        <td>From Device</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/From device.png' | url }}" alt="Insert picture image browse window" style="max-width:650px; width:100%; height:auto; vertical-align:middle"></td>
      </tr>
      <tr>
        <td>Stock Images</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Stock images.png' | url }}" alt="Stock Images gallery in Word" style="max-width:650px; width:100%; height:auto; vertical-align:middle"></td>
      </tr>
      <tr>
        <td>Online Pictures</td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Online pictures.png' | url }}" alt="Online Pictures gallery in Word" style="max-width:650px; width:100%; height:auto; vertical-align:middle"></td>
      </tr>
    </tbody>
  </table>
</div>
...
<img class="thumbnail" src="{{ '/assets/images/word/Images/Picture inserted.png' | url }}" alt="Inserted image of a dog with selection frame around it in Word" style="max-width:400px; width:100%; height:auto; vertical-align:middle">
...
<table>
  <colgroup>
    ...
    <thead>
      ...
      <tbody>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Insert shapes.png' | url }}" alt="Insert shapes from Insert on ribbon in Word" style="max-width:250px; width:100%; height:auto; vertical-align:middle"></td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Insert icons.png' | url }}" alt="Insert icons from Insert on ribbon in Word" style="max-width:250px; width:100%; height:auto; vertical-align:middle"></td>
        <td><img class="thumbnail" src="{{ '/assets/images/word/Images/Insert 3D models.png' | url }}" alt="Insert 3D models from Insert on ribbon in Word" style="max-width:250px; width:100%; height:auto; vertical-align:middle"></td>
      </tbody>
</table>
</div>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Stock images gallery.png' | url }}" alt="Stock images icon gallery in Word" style="max-width:550px; width:100%; height:auto; vertical-align:middle"></p>
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/Icon examples.png' | url }}" alt="Icon examples in Word" style="max-width:550px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/SmartArt example.png' | url }}" alt="SmartArt example in Word" style="max-width:650px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Chart word inserted.png' | url }}" alt="Chart inserted onto page in Word" style="max-width:650px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Excel chart copy paste into word.gif' | url }}" alt="Excel chart copied and pasted from Excel into Word"  style="max-width:800px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><img class="thumbnail left" src="{{ '/assets/images/keyboard shortcuts/Win+Shift+S.png' | url }}" alt="Shortcut keys Windows + Shift + S to take a screenshot" style="max-width:400px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/WordArt menu.png' | url }}" alt="WordArt menu on ribbon in Word" style="max-width:350px; width:100%; height:auto; vertical-align:middle"></p>
