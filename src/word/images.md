...
<th>Definition</th>
<th>Examples/Types/Categries</th>
</tr>
</thead>
<tbody>
<tr>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Ribbon%20images.png' | url }}" alt="Inserting images" style="display: inline; margin: auto; height: 30%; width: 30%;"></p>
<ul>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Insert%20shapes%20options.png' | url }}" alt="Insert shapes options" style="max-width: 100%; height: auto; display: inline; margin: auto;"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/Images/Icon%20examples.png' | url }}" alt="Icons" style="max-width: 75%; height: auto; display: inline; margin: auto;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/3D%20models.png' | url }}" alt="3D models gallery" style="max-width: 75%; height: auto; display: inline; margin: auto;"></p>
...
<img class="thumbnail" src="{{ '/assets/images/word/Images/Chart%20menu.png' | url }}" alt="Chart option" style="max-width: 75%; height: auto; display: inline; margin: auto;"></p>
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Chart.png' | url }}" alt="Chart" style="max-width: 100%; height: auto; display: inline; margin: auto;"></p>
...
<p><img class="thumbnail border" src="{{ '/assets/images/word/Images/Screen%20clipping%20inserted.gif' | url }}" alt="Screen clipping inserted" style="max-width: 100%; height: auto; display: inline; margin: auto;"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/keyboard shortcuts/Win+Shift+S.png' | url }}" alt="Screenshot shortcut Windows + Shift + S" style="max-width: 50%; height: auto; display: inline; margin: auto;"></p>
