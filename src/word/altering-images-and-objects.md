...
<div class="difficulty beginner-version"  aria-label="Beginner introduction to altering images">
  ...
  <p>When you insert an image or object it is automatically selected with a <strong>selection frame</strong> around it. The selection frame is how you edit it; it has white dots around it called <strong>sizing handles</strong> which you can use to resize it as needed. Some will also have a <strong>rotate handle</strong> icon to rotate your image/shape freely.</p>
  <p>Your mouse's cursor icon will change depending on where you hover it. The cursor icon that appears indicates available actions you can do by <span class="glossary-hover" data-term="drag">clicking and dragging</span>.</p>
  ...
  <table class="word-images-cursor-icons hover-table">
      ...
      <p>When the image/shape is selected you'll also see a small box appear top right, click this to see the <strong>layout options</strong> which include several <strong>wrapping</strong> styles. Wrapping is where the image/object can move between, above or below the text rather than in line with it (which is the default). Wrapping can greatly improve your document's layout, readability and aesthetics.</p>
      ...
      <tbody>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options in line with text example.png' | url }}">
          ...
          <td>This is the default option. The image/shape sits alongside text sharing the same line.</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options square wrap example.png' | url }}">
          ...
          <td>Text wraps around the image/shape’s selection frame. This is useful for placing images/shapes beside paragraphs or in columns.</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options tight wrap example.png' | url }}">
          ...
          <td>Text treats the image/shape like a solid block and flows around it but won't enter any internal gaps. This works well for things like Logos, cutouts and images with transparent backgrounds where you want the text to wrap 'tightly' around the image/shape.</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options through wrap example.png' | url }}">
          ...
          <td>Same as above but text will also wrap through transparent or open areas inside the image. This is really only noticeable on particular shapes with transparency to work (e.g. the animation has a curved arrow with space inside the text can occupy, but notice it only goes so far).</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options top and bottom wrap example.png' | url }}">
          ...
          <td>Text remains above and below the image/shape, not beside it. This is useful for isolating images to make them stand out.</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options behind text wrap example.png' | url }}">
          ...
          <td>This is one where the image 'floats' behind text like a background. This is useful for watermarks or decorative backgrounds, though it may make text hard to read. With this wrap option the image/shape can be moved freely anywhere on the page.</td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/Layout options in front of text wrap example.png' | url }}">
          ...
          <td>This is the opposite of the above so the image/shape 'floats' over the text. <u>Note</u>: Careful as the image will obscure anything beneath it. This is mostly used for overlays, callouts, or dramatic visual effects. The floating nature of this type of wrap lets you move it anywhere on the page freely.</td>
        </tr>
        </tbody>
        </table>

  <p>When you select one of the text wrapping options you'll notice two other options become active. Hover over below to see how each work:</p> 
  ...
  <table class="word-images-cursor-icons hover-table">
      ...
      <tbody>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/\Layout options move with text.gif' | url }}">
          ...
          <td><p>This is the default selected option. The image/shape will around move with the text when text or any other content is added or removed before it.</p><p><u>Note</u>: This won't work for wrapping behind and in front of text.</p></td>
        </tr>
        <tr class="tooltip-row" data-gif="{{ '/assets/images/word/Images/\Layout options fix position on page.gif' | url }}">
          ...
          <td>This fixes the image/shape to stay in place on the page unaffected by any text or content added or removed before it. Text will flow around the image/shape instead.</td>
        </tr>
      </tbody>
  </table>
  ...
  <p><strong>Floating images</strong> (i.e. wrapping styles 'Square', 'Tight', 'Through', 'Top and Bottom', 'Behind Text' and 'In front of Text') can be positioned anywhere on the page. However they are also 'anchored' to a specific paragraph. When using these wrapping options you'll see a small blue anchor in the left margin when it's selected. this shows where the image/shape is anchored to.</p>

  <img class="thumbnail left" src="{{ '/assets/images/word/Images/Anchor icon.png' | url }}" alt="Anchor icon" style="max-width:40px; width:100%; height:auto; vertical-align:middle">

  <p><u>Note</u>: Anchoring doesn't apply to images/shapes set to <strong>In Line with Text</strong> wrapping won't have an anchor because it's treated as part of the text layer itself.</p>

  <p>Anchors are helpful if you have the default option <strong>Move with text</strong> enabled because it help to indicate if your image/shape is going to shift position if the paragraph it's anchored to — or one before it — moves.</p>
  ...
  <p>If you drag floating images up or down the page, Word will reassign the anchor to a different nearby paragraph. In some cases you might want the image/shape to move with a particular paragraph regardless of whether it's nearby or not. The solution here is to 'lock' the anchor to a paragraph, which is discussed more in the Intermediate version of this article.</p>
...
<div class="difficulty intermediate-version" aria-label="Intermediate article exploring altering images" style="display:none;">
  ...
  <br>
  <p>Content-wise the below applies specificaly to these images and objects:</p>
  <ul>
    <li><a href="/word/images/#image-insert">Images/Pictures</a></li>
