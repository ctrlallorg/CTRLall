...
<p><img class="thumbnail" src="{{ '/assets/images/word/Styles/Create New Style options Properties Formatting.png' | url }}" alt="Create New Style from Formatting options window Properties and Formatting highlighted" style="display: inline; width: 60%;"></p>
...
<p><img class="thumbnail" src="{{ '/assets/images/word/Styles/Create New Style options More properties.png' | url }}" alt="Create New Style from Formatting options window More properties highlighted" style="display: inline; width: 60%;"></p>
