...
<h1>Indents</h1>
<div class="interactivity-badge">Includes interactive elements, scroll down to have a go yourself. &#8595;</div>
...
<section class="section-light">
  ...
  <p>There are two buttons under <strong>Home > Paragraph > Increase/Decrease Indent</strong> which allow you to increase or decrease an indent:</p>
...
function updateSvgIndent() {
  ...
  <p>You can set custom alignment points on the horizontal ruler called <strong>tab stops</strong> that control where the <span class="glossary-hover" data-term="insertion-point">insertion point</span> jumps to when you press the <strong>Tab</strong> key. This is much better than rather than relying on Word's default half-inch jumps or default left-centre-right alignment. See this article for more about creating custom tab stop alignments in your document <a href="/word/tab-stops/">Tab stops</a>.</p>
...
<section class="section-light">
  ...
  <p>Indents are the space between a margin and the paragraph. Here's what this article covers about indents:</p>
    <ul>
  ...
  <h3>Using Tab key to indent a paragraph</h3>
   <p>We're first going to just touch on something you may have already heard about regarding the <strong>Tab</strong> key. If you press Tab <i>before</i> a paragraph's first line it visually indents that first line 0.5" inward called a <span class="glossary-hover" data-term="first-line-indent" style="font-weight:bold;">first-line indent</span>. Alternatively, if you have the insertion point at the beginning of any line following the first line it will create a left indent, moving the whole paragraph over.</p>

   <p>If this is all you need to know then stick with that.</p>

   <h4>A technical nerdy 'However' point about the Tab key and indents</h4>
   <p>If you're teaching others Word, there's a slight difference between what the <strong>Tab</strong> key does and what an indent does that needs unpacking.</p>

  <p>The truth is the Tab key isn't designed to indent, instead what it actually does is move the <span class="glossary-hover"  data-term="insertion-point">insertion point</span> to the next default <span class="glossary-hover"  data-term="tab-stop" style="font-weight:bold;">tab stop</span>, which sits every 0.5" across the ruler. See more on tab stops here: <a href="/word/tab-stops/">Tab stops</a></p>
  ...
  <p>When you press Tab it moves the insertion point the next default tab stop. However at the same time Word’s default settings automatically apply the same shift to the paragraph’s <span class="glossary-hover"  data-term="first-line-indent">first‑line indent marker</span> (or if your insertion point is left of a line below the first line, the whole <span class="glossary-hover"  data-term="left-indent">left indent marker</span> moves, moving the whole paragraph right.)</p>

  <p>So the Tab key doesn't have anything to do with indents, it's Word’s automatic behaviour that changes the text's indentation. Essentially, Word blends the two features:</p>

  <ul>
    <li><strong>Tab</strong>: moves the insertion point to a tab stop</li>
    <li><strong>Indent</strong>: paragraph formatting</li>
  </ul>
...
<p>Here's what the indent markers do on lists:</p>
 ...
 <p>See the example below altering a single sub-bullet. Typically you'd want to adjust all the sub-bullets at once, in which case select them all first before altering the indent markers as needed.</p>
  <p><img class="thumbnail border" src="{{ '/assets/images/word/Indents/List indent marker adjust example.gif' | url }}" alt="Demontration adjusting list indent marker" style="display: inline; max-width:400px; width:100%; height:auto; vertical-align:middle"></p>
...
<h2 id="table-lists-and-indents-int">Table lists and indents</h2>
  ...
  <p><strong><i>Try this:</i></strong></p>
