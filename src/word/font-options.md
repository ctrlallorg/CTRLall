...
<img class="thumbnail border" src="{{ '/assets/images/word/Font options/Font options menus.png' | url }}"  alt="Different ways to open the Font options menus" style="max-width:800px; width:100%; height:auto; vertical-align:middle">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <p><img class="thumbnail" src="{{ '/assets/images/word/Font options/Underline style.png' | url }}" alt="Underline style drop down menu" style="display: inline; max-width:125px; width:100%; height:auto; vertical-align:middle"></p></td>
      </tr>
      <tr>
