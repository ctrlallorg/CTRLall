  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <p><img class="thumbnail" src="{{ '/assets/images/word/Font options/Hidden text.png' | url }}" alt="Hidden text made visible in Word" style="display: inline; margin: auto; width: 77%;"></p>
        </td>
      </tr>
    </tbody>
   </table>
