...
<section class="hero">
    ...
    <img src="{{ '/assets/images/Ctrl All logo purple.svg' | url }}"  alt="CTRL All logo" style="display: block; max-width:300px; width:100%; height:auto; vertical-align:middle">
</div>
  ...
  <div class="mv-container">
    ...
    <div class="mv-scroll">
      <a class="tutorial-card" href="/word/tables-convert-text-to-tables/">
        ...
        <p>Featuring downloadable exercise on how to convert text data into tables in Word.</p>
      </a>
      ...
      <a class="tutorial-card" href="/word/fixing-irregular-spacing/">
        ...
        <p>Ever pasted something into Word and the line spacing goes beserk? Here's how to fix it.</p>
      </a>
      <a class="tutorial-card" href="/word/indents/">
        <img src="" alt="">
        <h3>Indents</h3>
        <p>Try the interactivities in this article for everything about how to use indents in Word.</p>
      </a>
      ...
      <a class="tutorial-card" href="/word/getting-started-word/">
        <img src="/assets/images/Index/Featured/Getting started with Word thumbnail.png" alt="Getting started with Word thumbnail">
        <h3>Getting started with Microsoft Word</h3>
...
<section class="section-light">
  ...
  <ul>
    ...
    <li><a href="https://gadgetbond.com/microsoft-word-hyperlink-easy-insertion/" target="_blank">Microsoft making it easier to add hyperlinks to text in Word</a> — <u>Note</u>: only for web versions</li>
    <li><a href="https://microsoft.design/articles/fluid-forms-vibrant-colors/" target="_blank">Office 365 icons get a revamp</a></li>
