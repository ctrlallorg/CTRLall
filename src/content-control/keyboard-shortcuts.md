...
<p><a href="#windows-keyboard-shortcuts">Windows</a> | <a href="#word-keyboard-shortcuts">Word</a> | <a href="#excel-keyboard-shortcuts">Excel</a> | <a href="#powerpoint-keyboard-shortcuts">PowerPoint</a></p>
<br>
...
<p><img class="thumbnail border left" src="{{ '/assets/images/keyboard shortcuts/Windows key on keyboard.png' | url }}"  alt="Windows key on keyboard" style="max-width:250px; width:100%; height:auto; vertical-align:middle"></p>
...
<p><u>Note</u>: If you want to create your own shortuts go here: <a href="#custom-word-shortcuts">Create custom Word shortcuts</a></p>
<br>
<table class="shortcut-tables-cursor-icons hover-table">
  <colgroup>
    <col style="width: 10%;">
...
<h3 id="custom-word-shortcuts">Create custom Word shortcuts</h3>
<ol>
    <li>
        <p>Go to <strong>File > Options</strong>.</p>
        <p><img class="thumbnail border left" src="{{ '/assets/images/keyboard shortcuts/Word custom shortuts/File.png' | url }}" alt="File button in Word" style="max-width:215px; width:100%; height:auto; vertical-align:middle"></p>
        <p><img class="thumbnail border left" src="{{ '/assets/images/keyboard shortcuts/Word custom shortuts/File Options.png' | url }}" alt="File options button in Word" style="max-width:250px; width:100%; height:auto; vertical-align:middle"></p>
    </li>
    <li>
        <p>In the Word Options window click <strong>Customise Ribbon</strong>. On the new options' <strong>Choose commands from...</strong> drop down menu, choose <strong>All Commands</strong>.</p>
    ...
    <li>
        <p>Click into the right text field and press a combination of keys to assign a shortcut (e.g., <strong>Ctrl + Alt + Shift + D</strong>). It will tell you if a keyboard shortcut is already assigned elsewhere.</p>
    </li>
    <li>On the dropdown menu choose whether the keyboard shortcut should be applied to all documents in Word's global template (<strong>Normal</strong>), or just the current document.</li>
    <li>
        <p>Click <strong>Assign</strong>.</p>
        <p><img class="thumbnail border left" src="{{ '/assets/images/keyboard shortcuts/Word custom shortuts/Customise Keyboard.png' | url }}" alt="Customise Keyboard options in Word" style="max-width:600px; width:100%; height:auto; vertical-align:middle"></p>
    </li>
    <li>
        <p>Once assigned, the keyboard shortcut will transfer to the left field.</p>
        <p><img class="thumbnail border left" src="{{ '/assets/images/keyboard shortcuts/Word custom shortuts/Assigned.png' | url }}" alt="Assigned keyboard shortcut" style="max-width:600px; width:100%; height:auto; vertical-align:middle"></p>
    </li>
</ol>

<p></p>

<p>Afterwards your shortcut will work instantly. (If you're doing one for table you need to have clicked inside the table.)</p>
