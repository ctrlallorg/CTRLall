...
<div class="tooltip-wrapper" style="margin: 2rem 0rem 1rem; text-align: left;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The bar at the bottom of the screen showing details about what you are editing, language setting, accessibility, view options and the zoom tool. E.g. In MS Word the status bar will show the current document’s page number, total pages and <a href="#word-count">word count</a>.</td>
    </tr>
    <tr>
